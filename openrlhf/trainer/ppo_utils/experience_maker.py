...
class NaiveExperienceMaker(ABC):
    ...
    def make_experience_list(
        ...
        if self.strategy.ring_attn_group is not None:
            ...
            # sample_list = [Samples_1, Sample_2, ....]
            # len(sample_list) = len(all_prompts) * args.n_samples_per_prompt / args.micro_rollout_batch_size
            # len(sample_list[0]) = args.micro_rollout_batch_size
            samples_list = self.generate_samples(all_prompts, all_labels, **generate_kwargs)
        ...
        if not self.remote_rm_url:
            ...
            if self.strategy.ring_attn_group is None or self.strategy.ring_attn_rank == 0:
                ...
                if self.custom_reward_func:
                    ...
                    #     print(f"====================<queries>====================") 
                    #     print(queries[0])
                    #     print("queries_size: ", len(queries))
                    #     print("queries_type: ", type(queries))
                    #     print("queries_szie_0: ", len(queries[0]))
                    #     print("queries_type_0: ", type(queries[0]))
                    #     print(f"====================<prompts>====================")
                    #     print(samples.prompts[0])
                    #     print("prompts_size: ", len(samples.prompts)) 
                    #     print("prompts_type: ", type(samples.prompts))
                    #     print("prompts_szie_0: ", len(samples.prompts[0]))
                    #     print("prompts_type_0: ", type(samples.prompts[0]))
                    #     print(f"====================<labels>====================")
                    #     print(samples.labels[0])
                    #     print("labels_size: ", len(samples.labels))
                    #     print("labels_type: ", type(samples.labels))
                    #     print("labels_szie_0: ", len(samples.labels[0]))
                    #     print("labels_type_0: ", type(samples.labels[0]))

                    r = self.custom_reward_func.remote(queries, samples.prompts, samples.labels, args=self.strategy.args)
                    r_refs.append(r)
                    # if self.strategy.is_rank_0():
                    #     print(f"====================<ray_rewards>====================")
                    #     print(r)
                    #     print("reward_type: ", type(r))
                else:
