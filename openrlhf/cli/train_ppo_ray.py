...
if __name__ == "__main__":
    ...
    # reward funcs
    parser.add_argument("--reward_funcs", nargs='+', type=str, default=None, help="reward functions list")

    # reward funcs weights
    parser.add_argument("--reward_funcs_weights", nargs='+', type=float, default=None, help="reward functions weights")
